...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Oct 12, 2023 at 03:50 PM
...
--
-- Stand-in structure for view `cart_info`
-- (See below for the actual view)
--
...
CREATE TABLE `customers` (
  ...
  `customer_first_name` varchar(215) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `customer_last_name` varchar(215) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `email` varchar(215) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `phone` varchar(215) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `password` varchar(260) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
(31, 'Borris', 'Kouvelakis', 'boris@password.com', '0987654321', '$2b$10$eEKDjdp9QhTz0NbVGQMQWOX49pqUFUAwDyxd4RGcNU0MK26frtSM2');
...
--
-- Structure for view `cart_info`
--
DROP TABLE IF EXISTS `cart_info`;

CREATE ALGORITHM=UNDEFINED DEFINER=`babygrandad`@`%` SQL SECURITY DEFINER VIEW `cart_info`  AS SELECT `ci`.`entry_id` AS `entry_id`, `ci`.`cart_id` AS `cart_id`, `ci`.`product_id` AS `product_id`, `ci`.`color` AS `color`, `ci`.`size` AS `size`, `ci`.`quantity` AS `quantity`, `p`.`product_name` AS `product_name`, `p`.`price` AS `price` FROM (`cart_items` `ci` left join `products` `p` on((`ci`.`product_id` = `p`.`product_id`))) ;
